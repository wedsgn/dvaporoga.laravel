            ...
            <div class="container">
                ...
                <div class="car-single-parts">
                    @foreach ($parts as $part)
                        <x-car-single-part :image="$part['image']" :label="$part['label']" :title="$part['title']" :descr="$part['descr']"
                            :price="$part['price']" :priceOld="$part['priceOld']" :link="$part['link']" :alt="$part['alt']" />
                    @endforeach
                </div>
            </div>
        </section>
