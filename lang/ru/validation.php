...
$imageMax = config('uploads.image.label', '20 МБ');
$editorImageMax = config('uploads.editor_image.label', '5 МБ');
$importMax = config('uploads.import.label', '100 МБ');
...
return [
    ...
    */
    ...
    'max' => [
        ...
        'file' => 'Файл :attribute слишком большой. Проверьте максимальный размер загрузки.',
    ...
    'mimetypes' => 'Поле :attribute должно быть файлом одного из форматов: :values.',
    'min' => [
    ...
    'uploaded' => 'Не удалось загрузить :attribute. Возможно, файл превышает максимальный размер или загрузка была прервана.',
    ...
    */
    ...
    'custom' => [
        'image' => [
            'uploaded' => "Не удалось загрузить изображение. Возможно, превышен максимальный размер: {$imageMax}.",
            'max' => "Изображение слишком большое. Максимальный размер: {$imageMax}.",
        ],
        'image_mob' => [
            'uploaded' => "Не удалось загрузить мобильное изображение. Возможно, превышен максимальный размер: {$imageMax}.",
            'max' => "Мобильное изображение слишком большое. Максимальный размер: {$imageMax}.",
        ],
        'image_desktop' => [
            'uploaded' => "Не удалось загрузить десктопное изображение. Возможно, превышен максимальный размер: {$imageMax}.",
            'max' => "Десктопное изображение слишком большое. Максимальный размер: {$imageMax}.",
        ],
        'image_mobile' => [
            'uploaded' => "Не удалось загрузить мобильное изображение. Возможно, превышен максимальный размер: {$imageMax}.",
            'max' => "Мобильное изображение слишком большое. Максимальный размер: {$imageMax}.",
        ...
        'new_items.*.before' => [
            'uploaded' => "Не удалось загрузить изображение «до». Возможно, превышен максимальный размер: {$imageMax}.",
            'max' => "Изображение «до» слишком большое. Максимальный размер: {$imageMax}.",
        ],
        'new_items.*.after' => [
            'uploaded' => "Не удалось загрузить изображение «после». Возможно, превышен максимальный размер: {$imageMax}.",
            'max' => "Изображение «после» слишком большое. Максимальный размер: {$imageMax}.",
        ],
        'file' => [
            'uploaded' => "Не удалось загрузить файл. Возможно, превышен максимальный размер: {$importMax}.",
            'max' => "Файл слишком большой. Максимальный размер: {$importMax}.",
        ],
        'file_exel' => [
            'uploaded' => "Не удалось загрузить файл. Возможно, превышен максимальный размер: {$importMax}.",
            'max' => "Файл слишком большой. Максимальный размер: {$importMax}.",
        ...
        'upload' => [
            'uploaded' => "Не удалось загрузить изображение. Возможно, превышен максимальный размер: {$editorImageMax}.",
            'max' => "Изображение слишком большое. Максимальный размер: {$editorImageMax}.",
        ],
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'image' => 'Изображение',
        'image_mob' => 'Мобильное изображение',
