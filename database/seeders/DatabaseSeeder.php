  ...
  public function run(): void
  {
    ...
    $pages = [
      ...
      [
        ...
        'meta_description' => 'Каталог кузовных запчастей. Арки, пороги, пенки дверей, заглушки, усилители порогов и другие детали для ремонта авто от производителя.',
        'meta_keywords' => '',
        'og_title' => 'Каталог запчастей | Два порога',
        'og_description' => 'Каталог кузовных запчастей. Арки, пороги, пенки дверей, заглушки, усилители порогов и другие детали для ремонта авто от производителя.',
