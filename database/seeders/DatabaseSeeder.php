    ...
    $pages = [
      [
        ...
        'title' => 'Ремонтные <br /><span>пороги</span>
                    ...
                    и <span>арки</span>',
        'description' => '',
        'meta_title' => 'Кузовные ремонтные арки и пороги для всех моделей авто!',
      ...
      [
        'title_admin' => 'Каталог',
        'slug' => 'katalog',
        'title' => 'Каталог запчастей "Два порога"',
        'description' => '<p>
        ...
        'meta_description' => 'Каталог кузовных запчастей. Арки, пороги, пенки дверей, заглушки, усилители порогов и другие детали для ремонта авто от производителя. Высокое качество, точное соответствие, быстрая доставка по всей стране.',
        'meta_keywords' => '',
