...
class UpdateRequest extends FormRequest
{
  ...
  public function rules(): array
  {
    return [
      ...
      // TAGS: tags[i][title], tags[i][sort]
      'tags' => ['nullable', 'array'],
      'tags.*.title' => ['nullable', 'string', 'max:255'],
      'tags.*.sort' => ['nullable', 'integer', 'min:0', 'max:100000'],

      // OFFERS
      'offers' => ['nullable', 'array'],
      'offers.*.title' => ['nullable', 'string', 'max:255'],
      'offers.*.price_from' => ['nullable', 'integer', 'min:0'],
      'offers.*.price_old' => ['nullable', 'integer', 'min:0'],
      'offers.*.currency' => ['nullable', 'string', 'max:10'],
      'offers.*.sort' => ['nullable', 'integer', 'min:0', 'max:100000'],
