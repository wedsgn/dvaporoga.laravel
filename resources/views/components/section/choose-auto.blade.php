            ...
            <form id="choose-car-form" method="post" action="{{ route('lead.store_car') }}" novalidate>
                ...
                <div class="form-policy-item">
                    <div class="form-policy">
                        <input type="checkbox" id="choose-check" name="policy" {{-- <— ВАЖНО --}} value="1"
                            {{-- <— accepted понимает 1/on/true/yes --}} {{ old('policy') ? 'checked' : '' }} required {{-- сработает, если убрать novalidate у формы --}}>
