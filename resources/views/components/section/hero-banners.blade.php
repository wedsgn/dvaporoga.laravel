 <div class="index-hero__banners">
           ...
           <div class="index-hero__slide_wrap">
             <div class="index-hero__slide_info">
               ...
               <p class="index-hero__slide_descr">
                 Ремкомплект предназначен для ремонта порогов при корозии, деформации или повреждений при ДТП.
               </p>
   ...
   <div class="swiper-button-next slider-arrow slider-arrow-next hero-banner-arrow-next">
     <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
       stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
