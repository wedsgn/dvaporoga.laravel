    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <div class="live-preview">
                        <form action="{{ route('admin.cars.update', $item->slug) }}" method="POST"
                            ...
                            <div class="row gy-4">
                                ...
                                <div class="col-xxl-6 col-md-6">
                                  <div>
                                      ...
                                      <input type="text" value="{{ $item->generation }}" class="form-control"
                              ...
                              <div class="col-xxl-6 col-md-6">
                                <div>
                                    ...
                                    <input type="text" value="{{ $item->years }}" class="form-control"
                            ...
                            <div class="col-xxl-6 col-md-6">
                                <div>
                                    ...
                                    <input type="text" value="{{ $item->body }}" class="form-control"
                            ...
                            <div class="col-xxl-6 col-md-6">
                                <div>
                                    <label for="valueInput" class="form-label">{{ __('admin.field_artikul') }}
                                        *</label>
                                    <input type="text" value="{{ $item->artikul }}" class="form-control"
                                    ...
                                    @if (!count($car_models) == 0)
                                        <select type="text" data-choices class="form-control" name="car_model_id"
                                            ...
                                            @foreach ($car_models as $car_model)
                                                <option value="{{ $car_model->title }}"
                                                    {{ $car_model->id == $item->car_model->id ? 'selected' : '' }}>
                                                    {{ $car_model->title }}
                                                </option>
                                            @endforeach
                                        </select>
