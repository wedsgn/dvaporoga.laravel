                    ...
                    <div class="live-preview">
                        <div class="table-responsive table-card">
                            <table class="table align-middle table-nowrap mb-0">
                                ...
                                <tbody>
                                    @forelse ($request_consultations as $item)
                                        <tr>
                                            <td>{{ $item->id }}</td>
                                            <td>{{ $item->name }}</td>
                                            <td>{{ $item->phone }}</td>
                                            ...
                                            <td>
                                                ...
                                                <div class="dropdown d-inline-block">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end" style="">
                                                        <li><a href="{{ route('admin.request_consultations.show', $item->id) }}"
                        ...
                        @if ($request_consultations->links()->paginator->hasPages())
                            {{ $request_consultations->links() }}
                        @endif
                    </div>
                </div>
            </div>
