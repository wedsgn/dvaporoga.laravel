        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">{{ __('admin.new_car_make_card_title') }}</h4>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="live-preview">
                        <form action="{{ route('admin.car_makes.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row gy-4">
                            ...
                            <div class="row gy-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea id="editor" class="form-control" name="og_description" placeholder="{{ __('admin.placeholder_text') }}"
                                        style="height: 234px;">{{ old('og_description') }}</textarea>
                                </div>
                                <div class="col-xxl-6 col-md-6">
                                    <div class="form-check mt-3">
                                        <input class="form-check-input" type="checkbox" id="isHidden" name="is_hidden"
                                            value="1" {{ old('is_hidden', false) ? 'checked' : '' }}>
