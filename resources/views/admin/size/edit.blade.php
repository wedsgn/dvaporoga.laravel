        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">{{ __('admin.edit_size_card_title') }} {{ $size->title }}</h4>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="live-preview">
                        <form action="{{ route('admin.products.sizes.sizeUpdate', [$product->slug, $size->id]) }}" method="POST"
                            ...
                            <div class="row gy-4">
                                <div class="col-xxl-6 col-md-6">
                                    <div>
                                        ...
                                        <input type="text" value="{{ $size->title }}" class="form-control"
