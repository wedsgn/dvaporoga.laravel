...
<script>
  (function (w, d) {
    ...
    function fire(form, extra) {
      ...
      devLog('FIRE', { goal: goal, rawGoal: rawGoal, params: params });

      w.ym(YM_ID, 'reachGoal', goal, params);
    }

    w.YMGoals = w.YMGoals || { fire: fire };


    d.addEventListener('form:success', function (e) {
